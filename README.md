...
This package is forked from [soarecostin/file-vault](https://github.com/soarecostin/file-vault) to add Laravel 10 support. 
...
If you discover any security related issues, please email dev@iknowitza.com instead of using the issue tracker.

## Credits

- [iknowitza](https://github.com/iknowitzanl)
